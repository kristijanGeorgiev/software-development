...
const DUMMY_DINOSAURS = const [
  ...
  Dinosaur(
    ...
    name: 'Sarcosuchus',
    imageUrl: 'https://media.istockphoto.com/id/1477100499/photo/prehistoric-crocodile-sarcosuchus-underwater.jpg?s=612x612&w=0&k=20&c=7gm-oRV5jLKHwC6tNJaKql-ngllRaqCoWGb2XTHBUWg=',
    speed: 190,
    weight: 300,
    length: 210,
    height: 460,
    width: 150,
    description: 'Sarcosuchus is a distant relative of living crocodilians, with fully grown individuals estimated to have reached up to 9 to 9.5 m (29.5 to 31.2 ft) in total length and 3.45 to 4.3 metric tons (3.80 to 4.74 short tons) in weight.[2] It had somewhat telescoped eyes and a long snout comprising 75% of the length of the skull. There were 35 teeth in each side of the upper jaw, while in the lower jaw there were 31 teeth in each side. The upper jaw was also noticeably longer than the lower one, leaving a gap between them when the jaws were shut that created an overbite. In young individuals the shape of the snout resembled that of the living gharial, but in fully grown individuals it became considerably broader.',
  ),
];