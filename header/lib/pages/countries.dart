...
class CountryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget titleSection = const Padding(
      ...
      child: Text(
        'Countries', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.cyan), textAlign: TextAlign.center,
        softWrap: true,
      ),
    );
