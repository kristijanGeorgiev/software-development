...
import 'package:proba2/screens/screen2.dart';
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Image.network('https://www.anywhere.com/img-a/flora-fauna/sea-mammal/cachalote/sperm-whale.jpg?q=95&w=650'),
            Text('This is Sperm Whale')
          ],
        ),
      ),
      drawer: Drawer(
